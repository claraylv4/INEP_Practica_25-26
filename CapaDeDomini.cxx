...
void CapaDeDomini::registrarUsuari(const string& username, const string& nomcomplet, const date&data_naixement)
{
    DAOUsuari usuariDao;
...
void CapaDeDomini::modificarUsuari(const string& username,const string& nou_nom,const date& nova_data)
{
    DAOUsuari usuariDao;
    if (!usuariDao.existeix(username))
